...
export default function EmpLeaderboardPage() {
  ...
  useEffect(() => {
    setDataLoaded(false);
    console.log("loading")
    axios.get("https://app-admin-api.asmitaiiita.org/api/emp/leaderboard/").then((response) => {
  ...
  return ( 
     ...
     <Container>
      <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
        <Typography variant="h4">Employee Leaderboard - INTER IIIT 2024  </Typography>
   ...
   onChange={(event)=>{
    ...
    <Button sx={{mr: "1"}} onClick={()=>{
      ...
      axios.patch(`https://app-admin-api.asmitaiiita.org/api/emp/leaderboard/${str}`,{
        Points: newPoints
      }, {
        headers: header
      }).then(()=>{
